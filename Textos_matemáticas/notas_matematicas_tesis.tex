...
1: Si $x,x'$ son signos de variables y $c,c'$ de constantes (véase nota \ref{apóstrofe}), son fórmulas $x=x'$, $x=c$, $c=x$ y $c=c'$.
...
%--------------------------
\chapter{Sobre categoricidad y estructuras matemáticas}
...
La noción de isomorfía enlaza naturalmente con la de categoricidad, que pasamos a definir a continuación:
...
%------------------------------
\chapter{La teoría de categorías en la fundación de las matemáticas}
