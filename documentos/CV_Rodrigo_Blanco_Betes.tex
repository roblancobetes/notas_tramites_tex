...
\medskip
Matemático y doctorando en lógica matemática en la UPV/EHU, con experiencia en análisis de datos y desarrollo de soluciones analíticas en entornos profesionales. Combino una sólida formación teórica en análisis, fundamentos matemáticos y lógica con experiencia aplicada en estadística y Data Science. Interesado en la aplicación de métodos matemáticos y estadísticos a problemas reales, así como en la enseñanza de las matemáticas.
...
\vspace{15pt}
\centering
\includegraphics[width=3.5cm]{foto_cv2.jpeg}
\end{minipage}

% ── Experiencia académica y docencia ─────────────────────────────────────────────────────────────────
\section{Experiencia académica y docencia}

\cventry{Doctorado en Filosofía (especialización en lógica matemática)}%
        {Oct.\ 2023 -- actualidad}%
...
\begin{itemize}[nosep, leftmargin=1.2em, topsep=4pt]
  ...
  \item Docencia en las herramientas/lenguajes: Microsoft Power BI, Docker, Kubernetes, Java, Hadoop, Scala, Apache Spark, Azure.
  \item Aplicación de fundamentos matemáticos (álgebra, estadística, optimización) en contextos computacionales como criptografía, programación funcional y modelización.
\end{itemize}
...
\cventry{Docente}%
        ...
        {Bilbao, España}
\begin{itemize}[nosep, leftmargin=1.2em, topsep=4pt]
  \item Impartición del curso de formación profesional para el empleo \textit{Introducción al Big Data} (12 horas).
  \item Docencia en las herramientas/lenguajes: Microsoft Power BI, Google Looker Studio.
\end{itemize}
...
\cventry{Formación para la gestión y la investigación en la sanidad}%
        ...
        {Bilbao, España}
\begin{itemize}[nosep, leftmargin=1.2em, topsep=4pt]
  \item Curso en teoría de juegos y sesgos cognitivos y sus aplicaciones en la sanidad (12 horas).
  \item Curso en estadística y análisis de datos para la investigación y gestión sanitaria (4 horas).
\end{itemize}
...
\begin{itemize}[nosep, leftmargin=1.2em]
  \item \textbf{Programación:} Python, Scala, Haskell, Java, SQL.
