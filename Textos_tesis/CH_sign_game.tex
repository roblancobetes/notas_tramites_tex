...
I think that many of these problems disappear if we fully understand the distinction between commitment to structures or to an axiomatic system. We can only account for the way mathematical practice deals with a result such as Dedekind's only if considering such distinction.


Instead, I am just stating that they could be applied, restrictively, much more suitably in the case of arithmetic: it is much easier to argue that second order logic better captures the informal language of mathematics in the case of arithmetic, as in Dedekind's categoricity argument, than in the one of set theory.
