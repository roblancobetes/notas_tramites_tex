...
For this reason, I think we should also take into account, in this regard, views such as those presented in chapter 7 of \textcite{Resnik1997}, where he defends that a mathematical theory, given by axioms, merely describes a structural pattern, without necessarily determining a unique and privileged structure that models that theory. A clear and paradigmatic case of this approach in mathematical practice is category theory. The axiomatic basis of this theory is the definition of a category $\mathcal{A}$, which consists of the following elements:
...
Such a simple and concise list of axioms is applicable to a wide variety of areas of mathematics, such as groups, topological spaces, sets, relations, partially ordered sets, differentiable manifolds, and many others. What matters in practice, however, are the particular collections that instantiate these axioms, rather than whether there exists a fundamental and privileged structure that realizes them. Views such as that of the ``category of all categories'' have been proposed, but they are not central to mathematical practice (see \textcite{maclane1998categories}).

For this reason, I do not think that either of the two approaches---the priority of axioms and patterns, or that of structures over them---is unanimously adopted in mathematical practice, nor that one should be universally prioritized. Rather, we should draw a distinction between them. In cases where structures are grasped prior to the axiom systems that characterize them, and axioms are only later formulated as fundamental statements about those structures---something that aligns more closely with \textit{ante rem} structuralism---I would say that mathematicians are \textit{committing to a mathematical structure}. 

In the opposite case, when mathematicians (especially since the advent of the formalist approach) proceed in the reverse direction---starting from an axiom system before having a clear structure that satisfies it---I would say that they are \textit{committing to a pattern}, or to an axiom system. In such cases, particularly when the system is non-categorical, this does not imply commitment to a determinate structure.


This was clear in the case of set theory, which I threat in detail in section \ref{set-theory}, and even of category theory. In this case 
...
Lakatos' conception of mathematical entities as emerging from proofs and refutations is iterative, it says how can entities and definitions emerge from previously accepted ones. How did, then, structures appear with no appeal to previously defined ones? Which were the original mathematical entities? I think that a certain scheme of proofs and refutations could indeed prevail, but not from previously defined entities but for trying to get along with questions in real life experience, and for simplifying real life processes.

This is much in line with Quine and Putnam's argument, and with Feferman's idea of conceptual structuralism. This translates to $S_0$
...
My objective in this section is to understand why mathematicians tend to commit to determinate structures. I depart from some of the ontological and epistemological assumptions of \textit{ante rem} structuralism, in particular the view that mathematicians’ ontological commitments are fundamentally to structures, and that they are able to grasp them through simple pattern recognition. I argue that this ability is limited in practice to restricted cases—such as counting, projecting, or reasoning about limits—but does not extend to more sophisticated methods, such as the implicit definition of a structure via an axiomatic system in second-order logic.

As noted in the previous section, I aim to integrate this conception with insights from the philosophy of mathematical practice, especially the the iterative, heuristic, and problem-driven character that Lakatos’ quasi-empiricism attributes to mathematical reasoning.

To this end, I examine one of the most paradigmatic cases in the history of mathematics in which a mathematical structure was introduced and eventually accepted, despite initially being regarded as metaphysical and ill-defined: the development of complex numbers from the sixteenth to the nineteenth century. This is a case that illustrates how acceptance emerges from sustained mathematical practice rather than immediate structural recognition. I outline the reasons why complex numbers, in particular, shifted from being rejected or ignored to becoming one of the most central concepts in mathematics.
