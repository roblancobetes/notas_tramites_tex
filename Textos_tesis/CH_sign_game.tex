...
Moreover, these structures occupy a distinctive position within mathematical practice because of their deep entrenchment in scientific applications and everyday forms of reasoning.
 ...
 Counting, measurement, spatial representation, and quantitative modelling all rely on them in essential ways. In the terminology introduced in Section \ref{quasi-emp-structuralism}, they provide some of the clearest examples of externally applicable structures.
...
Non standars models: $\omega+ \mathbb{Z} \eta$ 

A simple idea, a biyection between the future days in the calendar (the standard model fits but non-standard do not).
