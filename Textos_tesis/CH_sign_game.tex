...
Maddy bel. axioms: axioms of set theory gain extrinsic evidence instead of intrinsic. This implies that practicioners have adopted this axioms, but not the corresponding structures in a determinate form.
