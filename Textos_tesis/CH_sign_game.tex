...
In my view, the most important takeaway from mathematical structuralism is the idea that structures are the fundamental primitive concept in mathematics, and that in general, mathematitians tend to think in terms of structures. Specially chapters 5 and 6 in \textcite{Shapiro1997} are really succesful to show how integrated structures have been in various stages in history of mathematics, such as in \textcite{Dedekind1888}, or \textcite{Bourbaki1950}, where this group defended a notion of ``structure'' as a collection endowed with one or several relations, developed to satisfy a determinate set of axioms. 

Precisely at this point, a \textit{chicken or egg} kind of problem could appear. More precisely, the question is whether structures are prior to the axioms that characterize them, or whether, on the contrary, structures are introduced and determined through axiomatic specification. On the one hand, structuralism—especially in its ante rem form—suggests that axioms merely describe independently existing structures. On the other hand, mathematical practice often proceeds by first stipulating axioms and then taking any system satisfying them to instantiate the relevant structure. 
...
\textbf{Structures are the primitives in mathematics}

\textbf{Structures vs axioms}
...
%=========================
\section{Further comments on naturalism}
