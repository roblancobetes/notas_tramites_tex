...
to indicate that $S_2 \in \mathcal{S}$ because it fulfulls conditions \ref{condition1}–\ref{condition3} with respect to $S_1 \in \mathcal{S}$. Then for any structure $S \in \mathcal{S}$, there is a sequence 
...
\textcite{maclane1986mathematics} defends that the structure of natural numbers is 
