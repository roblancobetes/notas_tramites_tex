...
It is also quite reasonable to argue that we can grasp structures prior to the axiom systems that characterize them, and that it is only later on that we can give axioms as true fundamental statements about them. These axioms could perhaps be insufficient to completely characterize the structure. If we don't find categoricity results in second order logic convincing enough, then axioms and structures have to be conceived in a different way. There is a fundamental epistemic and ontological difference between \textit{commiting to a mathematical structure} and \textit{comitting to an axiom system}, in case the later is not categorical.  It is commitment to structures that makes us able to speak of minimal closures, not the use of second order logic. 
