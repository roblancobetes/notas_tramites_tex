...
%----Appealing fact: structures cannot be determined axiomatically------
...
%---------Why do structures then exist; how do we know them?---------
...
%-----Why axioms as declaratives neq axioms as institutions?---
Preparatory conditions are the main difference.
...
Since Quine, contingency and necessity are slippery topics. Where are we placing the ``level'' of necessity? Are we talking on logical necessity (which mathematical statements are not), physical, humanly understandable necessity? 

Statements such as ``if $\mathbb{N}$ exists then $2+2=4$'' are probably necessary, but the statement ``$\mathbb{N}$ exists'', which is more fundamental to mathematics, is much harder to be considered as such. 
...
Institutional theories often emphasize what mathematical communities accept as valid.

%On objectivity: truth vs acceptance
Critics argue that:

Communities can be mistaken.
A theorem can be true before anyone proves it.
A proof can contain an unnoticed error despite community acceptance.

Thus truth seems different from institutional endorsement.

The worry is that institutional theories collapse mathematical truth into social consensus.
...
A famous challenge comes from the "unreasonable effectiveness" problem associated with Eugene Wigner.

Mathematics developed for purely theoretical reasons often later turns out to describe physical reality with remarkable precision.
...
Critics argue that if mathematics is simply an institution of human practice, it is difficult to explain why it fits the structure of the physical world so well.

\begin{quote}
The Peano Axioms are true because they have been accepted as an optimal characterization of a collection of objects, i.e., the natural numbers, appropriate for mathematicians' purposes. More generally, because mathematicians get to decide which mathematical objects should be constituted to serve their purposes, and get to decide which basic claims best characterize such objects, roughly speaking, mathematicians do indeed stipulate the basic truths about mathematical domains. \parencite[124]{Cole2008MathematicalDomains}
\end{quote}

\begin{quote}
Further, mathematical practices, as spatio-temporally instantiated activities, can causally influence human beings to become (at least minimally) competent participants in them. Consequently, mathematical practices can causally influence human beings to have systematically true pure mathematical beliefs. Think, for example, of how school teachers influence their pupils to become minimally competent participants in mathematical practices. This influence begins with such rudimentary lessons as how to add together two natural numbers, includes an introduction to axiomatic characterization and deduction from axioms, usually in the form of Euclidean Geometry, and will, in the mathematically sophisticated classroom, incorporate discussions of how to characterize the continuity of real valued functions using epsilons and deltas. \parencite[124]{Cole2008MathematicalDomains}
\end{quote}

%-----The possibility of revolutionary mathematics-----

Critics point to episodes where major advances challenged prevailing institutions.

Examples include:

Georg Cantor and transfinite numbers.
Nikolai Lobachevsky.
Bernhard Riemann.

These innovators were initially rejected by parts of the mathematical community.

If institutions define mathematical validity, critics ask how revolutionary mathematics can ever be justified against institutional resistance.

\begin{quote}
According to social constructivists, a similar situation arises in mathematics. Frequently, one mathematician is responsible for the mathematical community taking an interest in a particular mathematical domain. Consequently, from the perspective of a social constructivist, one individual is responsible for introducing the mathematical practice that constitutes that domain. Yet mathematical domains are sharable because mathematicians use shared logical tools (e.g., first and higher-order quantification) to characterize and constitute those domains. These shared logical tools allow mathematicians to characterize the domains they seek to theorize about, specifically, how they are structured into objects, properties and relations. \parencite[128]{Cole2008MathematicalDomains}
\end{quote}
...
Contar historia inventada de Peano (como ``creador'' de los numerous naturales) 

%-----Instituciones en el sentido de declaraciones no es lo mismo que instituciones como la RAE--
