...
The text is organized as follows. In Section \ref{conceptual-structuralism-intro}, I reconstruct Feferman’s conceptual structuralism and its relation to CH. I then examine (Sections \ref{science-applicability} and \ref{mathematical-practice}) the role of mathematical practice and scientific applicability in evaluating the determinacy of mathematical structures. In Sections \ref{categoricity-second-order-logic} and \ref{standard-models}, I analyze categoricity, second-order logic, and the problem of standard models, comparing the cases of arithmetic and set theory. Finally, in Section \ref{conclusion-Koellner-clarity}, I reassess Koellner’s critique and argue that the asymmetries between arithmetic and higher set theory in ordinary mathematical practice support a revised interpretation of conceptual structuralism that is more resistant to his criticism.
...
\begin{quote}
\small
There is no time to elaborate these points, but various aspects of them will come up in our discussion of two constellations of structural notions, first of objects generated by one or more “successor” operations, and second of the continuum. \parencite[p. 12]{Feferman2011a}.
\end{quote}
\end{adjustwidth}
...
\begin{quote}
\small
Basic conceptions differ in their degree of clarity. One may speak of what is true in a given conception, but that notion of truth may only be partial. Truth in full is applicable only to completely clear conceptions. \parencite[p. 11]{Feferman2011a}.
\end{quote}
\end{adjustwidth}
...
Feferman subsequently conjectured that CH is indefinite in this axiomatic system; that is, that one cannot derive $\mathrm{CH} \lor \neg \mathrm{CH}$. He went further still, conjecturing that CH also remains indefinite in the stronger system $\mathrm{SCS} + \mathcal{P}(\mathbb{N})$, which postulates the existence of the power set of the natural numbers. Both conjectures were later confirmed by \parencite{Rathjen2016}.
...
\begin{quote}
\small
The objective of this paper is to prove Feferman's conjecture. In this sense it is a technical paper (...). However, as far as the ongoing discussions of the foundational status of CH are concerned, readers will have to form their own conclusions. \parencite[p. 743]{Rathjen2016}.
\end{quote}
\end{adjustwidth}
...
\begin{quote}
\small
There is a hint of an answer to this question in his remarks on the role of mathematical models in physics. For in addition to thinking that no mythical third realm (the platonic realm) can secure the definiteness of set theory, he also thinks that the physical world cannot secure the definiteness of set theory. \parencite[p. 507]{Koellner2016}.
\end{quote}
\end{adjustwidth}
...
\begin{quote}
\small
Though I am not now nor never have been a predicativist, I have to admit to being a sympathizer since I am an avowed anti-platonist, at least insofar as set theory is concerned, and I grant the natural numbers a position of primacy in our mathematical thought. \parencite[313]{Feferman2004a}
\end{quote}
\end{adjustwidth}
